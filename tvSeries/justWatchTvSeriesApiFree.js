...
const CONFIG = {
    justWatchUrl: 'https://apis.justwatch.com/content/titles/en_US/popular',
    genre: {
        horror: '%22hrr%22',
        scifi: '%22scf%22',
        drama: '%22drm%22',
...
function doSetTimeout(i) {
    setTimeout(function() {
        ...
        let provider = movieList[i]
        request(
            'https://apis.justwatch.com/content/titles/en_US/popular?body=%7B%22page_size%22:1,%22page%22:1,%22query%22:%22' + provider + '%22,%22content_types%22:[%22show%22]%7D',
